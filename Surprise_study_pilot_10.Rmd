...
df9_raw <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_PRF_pilot_fdbk_bignrnd_typ_YPAG_v6_task_main.csv")
...
dfs_9_10 <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/pilots_9_10_variables.csv")
...
# summarized_dfs_9_10$Pilot_Number_Jittered <- as.numeric(as.character(summarized_dfs_9_10$Pilot_Number)) + runif(nrow(summarized_dfs_9_10), -0.1, 0.1)
# summarized_dfs_9_10$Pilot_Number <- as.factor(summarized_dfs_9_10$Pilot_Number)
