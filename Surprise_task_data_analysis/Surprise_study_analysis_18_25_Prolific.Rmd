...
This is the first surprise study using the same task version as pilot 21. We had the following groups of participants with the experiment's corresponding Gorilla link: - Prolific aged 18-25 (n = 30): <https://app.gorilla.sc/admin/experiment/180921/design> - Prolific aged 26-45 (n = 38): <https://app.gorilla.sc/admin/experiment/185160/design> - School students aged 14-18 (n = 30): <https://app.gorilla.sc/admin/experiment/177048/design> - Promunity participants aged 18-25 (n = 24): <https://app.gorilla.sc/admin/experiment/180348/design>
...
dfpro_18_25_cesd <- read.csv("/Users/elenabagdades/Library/CloudStorage/OneDrive-UniversityCollegeLondon/Desktop/GitHub/aim_lab_1/De_identified_data/surprise_study_prolific_18-25/SUP_PRF_18-25_ces_d.csv")
```

```{r echo=FALSE, warning=FALSE, message=FALSE}
# extract CES-D scores
CESD_data_clean <- dfpro_18_25_cesd[, c(31, 33, 35, 37, 39, 41, 43, 45, 47,49,51,
...
model4 <- lme4::lmer(Response_H ~ Response_SubjPE + Social_Anxiety + (Response_SubjPE | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
...
model4 <- lme4::lmer(Response_Ax ~ Response_SubjPE + Social_Anxiety + (Response_SubjPE | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
model1 <- lme4::lmer(Response_H ~ Response_pred +  (Response_pred | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model2 <- lme4::lmer(Response_H ~ Response_pred +  mini_SPIN_total + (1 | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model3 <- lme4::lmer(Response_H ~ Response_pred + mini_SPIN_total + (Response_pred | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model4 <- lme4::lmer(Response_H ~ Response_pred + Social_Anxiety + (Response_pred | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
model1 <- lme4::lmer(Response_Ax ~ Response_pred +  (Response_pred | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model2 <- lme4::lmer(Response_Ax ~ Response_pred +  mini_SPIN_total + (1 | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model3 <- lme4::lmer(Response_Ax ~ Response_pred + mini_SPIN_total + (Response_pred | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model4 <- lme4::lmer(Response_Ax ~ Response_pred + Social_Anxiety + (Response_pred | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
...
```{r}
model1 <- lme4::lmer(Response_H ~ Response_fdbk +  (Response_fdbk | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model2 <- lme4::lmer(Response_H ~ Response_fdbk +  mini_SPIN_total + (1 | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model3 <- lme4::lmer(Response_H ~ Response_fdbk + mini_SPIN_total + (Response_fdbk | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model4 <- lme4::lmer(Response_H ~ Response_fdbk + Social_Anxiety + (Response_fdbk | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
...
```{r}
model1 <- lme4::lmer(Response_Ax ~ Response_fdbk +  (Response_fdbk | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model2 <- lme4::lmer(Response_Ax ~ Response_fdbk +  mini_SPIN_total + (1 | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model3 <- lme4::lmer(Response_Ax ~ Response_fdbk + mini_SPIN_total + (Response_fdbk | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
model4 <- lme4::lmer(Response_Ax ~ Response_fdbk + Social_Anxiety + (Response_fdbk | Random_ID), data = final_df_18_25_Pro, control=lmerControl(optimizer="bobyqa"))
