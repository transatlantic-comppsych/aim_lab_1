...
```{r echo=FALSE}
df1 <- read.csv("/Users/marjan/Desktop/aim_lab_1/De_identified_data/surprise_pilot_4/SUP_PRF_pilot_pred_nopic_vid_v5/SUP_PRF_pilot_pred_nopic_vid_v5_task_main.csv") # Prolific, no picture taken
df2 <- read.csv("/Users/marjan/Desktop/aim_lab_1/De_identified_data/surprise_pilot_4/SUP_PRF_pilot_pred_nopic_aud_v5/SUP_PRF_pilot_pred_nopic_aud_v5_task_main.csv") # Prolific, no picture taken, only audio (no video)
...
ggplot(df12_pred, aes(x=Response, y=m_hist)) +
  ...
  labs(color="Legend") +
  facet_wrap(~ Random_ID, scales = "free", ncol = 10) +
  theme_minimal()+
  xlab("Expectation") + 
...
ggplot(df12_long, aes(x = trial_nr, y = Value, color = Metric, group = Metric)) +
  ...
  labs(title = "Expectation across time",
       ...
       y = "Expectation",
       color = "") +
  facet_wrap(~ Random_ID, ncol = 10) # Separate plot for each ID, one column layout
...
```{r echo=FALSE}
df3 <- read.csv("/Users/marjan/Desktop/aim_lab_1/De_identified_data/surprise_pilot_4/SUP_PRF_pilot_pred_nopic_vid_v8/SUP_PRF_pilot_pred_nopic_vid_v8_task_main.csv")   # Prolific, no picture taken, has both audio and video, histograms had different means () and sd = 3 to be narrower, this change was made to help us create histograms that would allow us create prediction errors more easily.
...
ggplot(df3_pred, aes(x = Response, y = m_hist)) +
  # geom_point(aes(color="Data Points")) +
  ...
  xlab("Prediction") + 
  ylab("Histogram means") +
  ggtitle("Relationship between Expectation and Histogram Means")
```
