...
model_8_mood_DEP_fit<- readRDS("model_8_mood_DEP_fit.rds")
posterior_DEP_mood <- rstan::extract(model_8_mood_DEP_fit)

model_8_anx_SA_fit<- readRDS("model_8_anx_SA_fit.rds")
posterior_SA_anx<- rstan::extract(model_8_anx_SA_fit)

model_8_mood_SA_fit<- readRDS("model_8_mood_SA_fit.rds")
posterior_SA_mood <- rstan::extract(model_8_mood_SA_fit)

data <- read.csv(here("Data", "Extracted_data","Merged Data - all groups", "merged_data_demographics.csv"))
...
df <- read.csv(here("Data", "Extracted_data","Merged Data - all groups", "merged_data_demographics.csv")
