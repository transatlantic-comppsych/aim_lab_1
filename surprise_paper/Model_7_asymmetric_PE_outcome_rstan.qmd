...
# recompiled_model <- stan_model(model_code = asymmPE_Outcome_anx)
# 
# recency_anx_fit@stanmodel <- recompiled_model
# 
# recency_anx_fit_info <- list(
#   stanfit = asymmPE_Outcome_anx_fit,
#   stanmodel = asymmPE_Outcome_anx_fit@stanmodel,
#   data = stan_data
# )
...
# Recompile the model (you'll need to keep the model code)
#recompiled_model <- stan_model(model_code = asymmPE_Outcome_mood)

#asymmPE_Outcome_mood_fit@stanmodel <- recompiled_model

#asymmPE_Outcome_mood_fit_info <- list(
 # stanfit = asymmPE_Outcome_mood_fit,
 # stanmodel = asymmPE_Outcome_mood_fit@stanmodel,
#  data = stan_data
#)
