...
mood_models_results <- read.csv(here("Computational Modelling", "Model_output","model_comp_results_mood.csv"))
...
anx_models_results <- read.csv(here("Computational Modelling", "Model_output","model_comp_results_anx.csv"))
...
model_8_mood <- readRDS("model_8_mood_fit.rds")
...
model_8_anx<- readRDS("model_8_anx_fit.rds")
