...
df_Eleanor <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/Aim1.Database Stage 2_11.2019.csv")
...
modelAx <- lm(Response_Ax ~ Response_SubjPE * mini_SPIN_total, data = df7_long_mini_SPIN)
summary(modelAx)


modelH <- lm(Response_H ~ Response_SubjPE * mini_SPIN_total, data = df7_long_mini_SPIN)
summary(modelH)
```
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
df8_spin <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_PRF_pilot_fdbk_biggestnrnd_typ_v3_mini_spin.csv")   # Prolific,non-random feedback, text only (no video/audio) with biggest PE, once per judge
