...
```{r echo=FALSE, warning=FALSE, message=FALSE}
df4 <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_AMT_pilot_fdbk_nrand_typing_novid_v4_task_main.csv")
df5 <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_AMT_pilot_fdbk_nrand_typing_novid_v5_task_main.csv")
...
```{r echo=FALSE}
df6 <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_PRF_pilot_fdbk_nrand_typing_novid_v3_task_main.csv")   # Prolific,non-random feedback, text only (no video/audio)
...
df6_raw <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_PRF_pilot_fdbk_nrand_typing_novid_v3_task_main.csv")   # Prolific,non-random feedback, text only (no video/audio)
...
df7_raw <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_PRF_pilot_fdbk_bignrnd_typ_v3_task_main.csv")   # Prolific,non-random feedback, text only (no video/audio) with bigger PE, once per judge, 37 (40 for now) subjects
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
df7_spin <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_PRF_pilot_fdbk_bignrnd_typ_v3_mini_spin.csv")   # Prolific,non-random feedback, text only (no video/audio) with bigger PE, once per judge
...
df7_long_mini_SPIN <- subset_df7 %>%
  left_join(df7_spin, by = "Random_ID")

model <- lm(Response_Ax ~ Response_SubjPE * mini_SPIN_total, data = df7_long_mini_SPIN)
summary(model)
```

```{r echo=FALSE, warning=FALSE, message=FALSE}

model <- lm(Response_H ~ Response_SubjPE * mini_SPIN_total, data = df7_long_mini_SPIN)
summary(model)
```
...
subset_df7 <- subset(df7_long_mini_SPIN, mini_SPIN_total >= 6)
ids_to_exclude <- c("SUPPRF67412")
...
df8_raw <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_PRF_pilot_fdbk_biggestnrnd_typ_v3_task_main.csv")   # Prolific,non-random feedback, text only (no video/audio) with biggest PE (1 feedback between 90-100), once per judge, 41 subjects
...
# 
# # Subset the data
# subset_df8 <- final_df8[!final_df8$Random_ID %in% ids_to_exclude, ]
...
```{r echo=FALSE, warning=FALSE, message=FALSE}
df8_spin <- read.csv("/Users/marjan/Desktop/pilot_surprise_SeptOCT2023/Pilot_surprise/SUP_PRF_pilot_fdbk_biggestnrnd_typ_v3_mini_spin.csv")   # Prolific,non-random feedback, text only (no video/audio) with bigger PE, once per judge
