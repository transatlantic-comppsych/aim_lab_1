...
<br> <br> For this study, we did not screen for social anxiety but need to see their social anxiety scores to see how many are bigger than or equal the threshold of 6.
...
print(paste("These people had a mini_SPIN total score lower or equal to 6:", count))
...
```
<br> <br>
So after keeping people with high mini_SPIN scores, the correlation becomes -0.21 from -0.18. <br>
