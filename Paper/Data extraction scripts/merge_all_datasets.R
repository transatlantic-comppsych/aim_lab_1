...
data_pilot21 <- read.csv(here("Paper", "Data", "Extracted_data", "Prolific participants", "pilot_21_variables.csv")) %>%
clean_data() %>%
...
data_pilot_21_lsas_v3 <- read.csv(here("Paper", "Data", "Raw_data", "Prolific participants", "Prolific participants (18-25; pilot 21)","SUP_PRF_p21_vid_bigPE_nohist_newjud_v3","SUP_PRF_p21_vid_bigPE_nohist_newjud_v3_lsas_sr.csv"))
data_pilot_21_lsas_v4 <- read.csv(here("Paper", "Data", "Raw_data", "Prolific participants", "Prolific participants (18-25; pilot 21)", "SUP_PRF_p21_vid_bigPE_nohist_newjud_v4", "SUP_PRF_p21_vid_bigPE_nohist_newjud_v4_lsas_sr.csv"))
...
data_18_25_pro <- read.csv(here("Paper", "Data", "Extracted_data", "Prolific participants", "surprise_study_18_25_Pro_variables.csv")) %>%
  clean_data() %>%
  rename(Depression_score = CESD_score) %>%
  mutate(Dataset = "18_25_Pro")
data_18_25_pro$Depression_score_scaled <- scale(data_18_25_pro[, c("Depression_score")])

data_18_25_pro_lsas <- read.csv(here("Paper", "Data", "Raw_data", "Prolific participants", "Prolific participants (18-25)", "SUP_PRF_18-25_lsas_sr.csv"))
...
data_26_45_pro <- read.csv(here("Paper", "Data", "Extracted_data", "Prolific participants", "surprise_study_26_45_Pro_variables.csv")) %>%
  clean_data() %>%
  rename(Depression_score = CESD_score) %>%
  mutate(Dataset = "26_45_Pro")
data_26_45_pro$Depression_score_scaled <- scale(data_26_45_pro[, c("Depression_score")])

data_26_45_pro_lsas <- read.csv(here("Paper", "Data", "Raw_data", "Prolific participants", "Prolific participants (26-45)", "SUP_PRF_26-45_lsas_sr.csv"))
cols_to_sum <- seq(29, 123, by = 2)
...
data_14_18 <- read.csv(here("Paper", "Data", "Extracted_data", "School participants", "surprise_study_14_18_variables.csv")) %>%
...
data_14_18_lsas_v7 <- read.csv(here("Paper", "Data", "Raw_data", "School participants", "surprise_study_schools_v7", "SUP_SCH_v7_lsas_ca.csv"))
data_14_18_lsas_v9 <- read.csv(here("Paper", "Data", "Raw_data", "School participants", "surprise_study_schools_v9", "SUP_SCH_v9_lsas_ca.csv"))
...
data_18_25_com <- read.csv(here("Paper", "Data", "Extracted_data", "Local Community Participants", "surprise_study_18_25_com_variables.csv")) %>%
  rename(Random_ID = Random_ID_new) %>%
  rename(Depression_score = CESD_score) %>%
  clean_data() %>%
...
data_18_25_com_lsas_v1 <- read.csv(here("Paper", "Data", "Raw_data", "Local Community Participants", "Local Community Participants v1", "SUP_COM_18-25_v1_lsas_sr.csv"))
data_18_25_com_lsas_v2 <- read.csv(here("Paper", "Data", "Raw_data", "Local Community Participants", "Local Community Participants v2", "SUP_COM_18-25_v2_lsas_sr.csv"))
...
# Add demographics  -------------------------------------------------------
merged_demo <- read.csv(here("Surprise_task_data_analysis", "merged_data_demographics.csv"))
...
# Merge participant-level data onto the long fromat dataset
